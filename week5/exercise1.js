...
// forEach(console.log)(
//   zip(a=>b=>[a,b])
//       (cons(1)(cons('a'))(undefined)))
//       (cons(2)(cons('b'))(undefined)))
// )
// [1,'a']
// [2,'b'] 
...
// const zip = f => a => b => {
//     if (a&&b) {
//         // console.log(f(head(a))(head(b)))
//         // return zip(f)(tail(a))(tail(b))
//         cons(f(head(a))(head(b)))(zip(f)(tail(a))(tail(b)))
//     }
//     return undefined;
//     // a && b ? cons(f(head(a))(head(b)))(zip(f)(tail(a))(tail(b))) : undefined;
// }

const zip = f => a => b => {
    if (a&&b) {
        console.log("HELLO");
        console.log(cons(f(head(a))(head(b))));
        return cons(f(head(a))(head(b))) (zip(f)(tail(a))(tail(b)))
    }
    return undefined;
}
    // a && b? cons(f(head(a))(head(b))) (zip(f)(tail(a))(tail(b))) : undefined;

// const zip = f => a => b => a && b ? cons(f(head(a))(tail(b))) (zip(f)(tail(a))(tail(b))) : undefined

print(zip(x=>y=>[x,y])(fromArray(students))(fromArray(marks)))
// expect:
// [ 'Valentino Dalton', '84.51' ]
// [ 'Hayden Walton', '42.85' ]
// [ 'Jane Bryant', '57.03' ]
// [ 'Ronald Hayes', '52.99' ]
// [ 'Journey Bradshaw', '65.39' ]
// ...